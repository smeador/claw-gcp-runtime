...
const lines = [
  ...
  "",
  "  claw-runtime local test skill SKILL_NAME",
  ...
  "  TAIL_LINES          Number of log lines for claw-runtime local logs",
  "  AGENT_NAME          Agent name for claw-runtime local agent-logs (default: main)",
  "  LOG_VIEW            claw-runtime local agent-logs view: messages (default), replies, errors, or full",
  "  SHOW_RUNTIME_LOG    Set to 1 to append the raw runtime log tail to claw-runtime local agent-logs",
  "  GMAIL_TEST_TO       Recipient for claw-runtime local test gmail-send",
  "  GMAIL_TEST_SUBJECT  Subject for claw-runtime local test gmail-send",
  "  SKILL_TEST_MESSAGE  Generic message override for claw-runtime local test skill",
  "  SKILL_TEST_TIMEOUT_MS  Generic timeout override for claw-runtime local test skill",
