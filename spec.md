...
- Native-local Gmail auth may use OAuth; Docker-local and cloud should use the Workspace service account path for `automation@example.com`.
...
- Gmail webhook setup uses:
  - `openclaw webhooks gmail setup --account automation@example.com --project claw-runtime-example --tailscale funnel`
