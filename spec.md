...
Secrets include:
- LLM API key
- Gmail Workspace service-account material for `pip@meador.me`
...
- The payload may include a `gog` branch for `pip@meador.me`; that branch should render to separate Gmail bootstrap artifacts rather than appearing in rendered `openclaw.json`.
