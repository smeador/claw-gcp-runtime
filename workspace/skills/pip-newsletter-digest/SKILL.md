...
- After generating the digest, email it by default to `sean@meador.me` from `pip@meador.me`
...
- After composing the digest, send it to `sean@meador.me` from `pip@meador.me`.
