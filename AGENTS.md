...
This file captures project-level working memory for agents operating on the repository itself. It complements [workspace/AGENTS.md](/path/to/claw-gcp-runtime/workspace/AGENTS.md), which is the runtime-facing workspace policy file used by the bot inside the reviewed workspace.
...
- Keep long-form docs in [docs](/path/to/claw-gcp-runtime/docs):
  - [docs/spec.md](/path/to/claw-gcp-runtime/docs/spec.md)
  - [docs/backlog.md](/path/to/claw-gcp-runtime/docs/backlog.md)
  - [docs/openclaw-agent-guide.md](/path/to/claw-gcp-runtime/docs/openclaw-agent-guide.md)
...
- The cloud gateway tunnel should go through [scripts/cloud/tunnel-gateway.sh](/path/to/claw-gcp-runtime/scripts/cloud/tunnel-gateway.sh).
